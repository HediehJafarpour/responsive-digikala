const loadCategories = async () => {
  try {
    ...
    // استخراج داده‌های بخش headersub
    const data = jsonData.headersub;
    ...
    const showDetails = (category) => {
      ...
      details.innerHTML = `
        <h2 class="text-[15px] w-full font-semibold flex flex-row-reverse items-center mb-[10px] text-[#19BFD3]"> 
          ${category.title} 
